      ...
      >
        ...
        >
          ...
          <div className="z-10 flex flex-col sm:flex-row md:flex-col gap-3 w-full md:w-auto shrink-0 sm:justify-center">
             ...
             <button 
               className="px-4 py-2 md:px-5 md:py-2.5 bg-brand-surface/20 text-white border border-white/30 text-[12px] md:text-sm font-bold rounded-full hover:bg-white/10 transition-all flex items-center justify-center"
               onClick={(e) => e.stopPropagation()} 
             >
                Read Documentation
             </button>
